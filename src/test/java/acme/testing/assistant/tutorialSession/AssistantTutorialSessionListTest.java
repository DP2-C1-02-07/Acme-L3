...
public class AssistantTutorialSessionListTest extends TestHarness {
	...
	public void test100Positive(final int tutorialRecordIndex, final int sessionRecordIndex, final String code, final String title, final String abstractSession) {
		//HINT: This test tries to list the sessions belonging to 
		...
		super.checkColumnHasValue(sessionRecordIndex, 2, abstractSession);
	...
	public void test300Hacking() {
		...
		for (final Tutorial t : tutorials) {
			...
			super.request("/assistant/tutorial-session/list", id);
