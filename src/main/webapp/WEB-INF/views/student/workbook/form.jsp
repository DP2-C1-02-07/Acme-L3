...
<acme:form>
	...
	<acme:input-textarea code="student.activity.form.label.activityAbstract" path="abstractElement"/>
	<acme:input-select code="student.activity.form.label.indicator" path="type" choices="${indicators}"/>
	...
	<jstl:if test="${ finalised == true}">
		<jstl:choose>
			<jstl:when test="${acme:anyOf(_command, 'show|update|delete')}">
				<acme:submit code="student.activity.form.button.update" action="/student/workbook/update"/>
				<acme:submit code="student.activity.form.button.delete" action="/student/workbook/delete"/>
			</jstl:when>
			<jstl:when test="${_command == 'create'}">
				<acme:submit code="student.activity.form.button.create" action="/student/workbook/create"/>
			</jstl:when>		
		</jstl:choose>
	</jstl:if>
</acme:form>